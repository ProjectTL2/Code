...
public class UserProfile extends javax.swing.JFrame {
    ...
    public UserProfile(User curUser, boolean q) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.curUser = curUser;
        jButton1.setVisible(q);
        jButton2.setVisible(q);
        jButton3.setVisible(q);
        jButton4.setVisible(q);
        jButton5.setVisible(q);
        jLabel1.setText(curUser.getUsername());
        jLabel3.setText(curUser.getPh_num());
        jLabel4.setText(curUser.getEmail());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        new EditProfile(curUser).setVisible(true);
